// api/index-en.js - Clean English Version Frontend
...
<head>
    ...
    <style>
        ...
        .message {
            ...
            animation: slideIn 0.3s ease; white-space: pre-wrap;
        }
        @keyframes slideIn {
        ...
        .user-message {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            color: white; align-self: flex-end; border-bottom-right-radius: 5px;
        }
        ...
        #uploadBtn {
            ...
            border-radius: 15px; padding: 6px 12px; cursor: pointer;
        ...
        .typing::after {
            content: '●●●'; animation: typing 1.4s infinite;
        }
        @keyframes typing {
        ...
        .progress-indicator {
            ...
            font-size: 11px; align-self: flex-start; margin-bottom: 10px;
        }
    </style>
</head>
<body>
...
Technical skills and business accomplishments.\`;
            ...
            async sendToAPI(message) {
                ...
                try {
                    const response = await fetch('/api/chat_en', {
                        method: 'POST',
